...
#include "order_msgs/srv/detail/order_food__rosidl_typesupport_fastrtps_c.h"
...
using _OrderFood_Request__ros_msg_type = order_msgs__srv__OrderFood_Request;
...
size_t get_serialized_size_order_msgs__srv__OrderFood_Request(
  const void * untyped_ros_message,
...
static uint32_t _OrderFood_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_order_msgs__srv__OrderFood_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_order_msgs
size_t max_serialized_size_order_msgs__srv__OrderFood_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = order_msgs__srv__OrderFood_Request;
    is_plain =
      (
...
static size_t _OrderFood_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_order_msgs__srv__OrderFood_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, order_msgs, srv, OrderFood_Request)() {
...
using _OrderFood_Response__ros_msg_type = order_msgs__srv__OrderFood_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_order_msgs
size_t get_serialized_size_order_msgs__srv__OrderFood_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _OrderFood_Response__ros_msg_type * ros_message = static_cast<const _OrderFood_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_order_msgs__srv__OrderFood_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_order_msgs
size_t max_serialized_size_order_msgs__srv__OrderFood_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = order_msgs__srv__OrderFood_Response;
    is_plain =
      (
...
static size_t _OrderFood_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_order_msgs__srv__OrderFood_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, order_msgs, srv, OrderFood_Response)() {
...
// already included above
// #include "order_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "order_msgs/srv/order_food.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, order_msgs, srv, OrderFood)() {
