...
bool order_msgs__srv__order__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("order_msgs.srv._order.Order_Request", full_classname_dest, 35) == 0);
  }
  order_msgs__srv__Order_Request * ros_message = _ros_message;
  {  // table_num
...
PyObject * order_msgs__srv__order__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("order_msgs.srv._order");
...
ROSIDL_GENERATOR_C_EXPORT
bool order_msgs__srv__order__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("order_msgs.srv._order.Order_Response", full_classname_dest, 36) == 0);
  }
  order_msgs__srv__Order_Response * ros_message = _ros_message;
  {  // success
