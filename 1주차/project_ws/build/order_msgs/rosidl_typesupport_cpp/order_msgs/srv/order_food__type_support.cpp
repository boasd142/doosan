...
static const _OrderFood_Request_type_support_symbol_names_t _OrderFood_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, order_msgs, srv, OrderFood_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, order_msgs, srv, OrderFood_Request)),
  }
};
...
{
  return &::order_msgs::srv::rosidl_typesupport_cpp::OrderFood_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, order_msgs, srv, OrderFood_Request)() {
  return get_message_type_support_handle<order_msgs::srv::OrderFood_Request>();
}
...
static const _OrderFood_Response_type_support_symbol_names_t _OrderFood_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, order_msgs, srv, OrderFood_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, order_msgs, srv, OrderFood_Response)),
  }
};
...
{
  return &::order_msgs::srv::rosidl_typesupport_cpp::OrderFood_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, order_msgs, srv, OrderFood_Response)() {
  return get_message_type_support_handle<order_msgs::srv::OrderFood_Response>();
}
...
static const _OrderFood_type_support_symbol_names_t _OrderFood_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, order_msgs, srv, OrderFood)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, order_msgs, srv, OrderFood)),
  }
};
...
{
  return &::order_msgs::srv::rosidl_typesupport_cpp::OrderFood_service_type_support_handle;
}
