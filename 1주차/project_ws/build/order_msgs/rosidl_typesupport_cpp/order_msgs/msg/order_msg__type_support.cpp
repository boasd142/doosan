...
static const _OrderMsg_type_support_symbol_names_t _OrderMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, order_msgs, msg, OrderMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, order_msgs, msg, OrderMsg)),
  }
};
...
{
  return &::order_msgs::msg::rosidl_typesupport_cpp::OrderMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, order_msgs, msg, OrderMsg)() {
  return get_message_type_support_handle<order_msgs::msg::OrderMsg>();
}
