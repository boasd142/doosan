...
#ifndef ORDER_MSGS__SRV__DETAIL__ORDER_FOOD__FUNCTIONS_H_
#define ORDER_MSGS__SRV__DETAIL__ORDER_FOOD__FUNCTIONS_H_
 ...
 * calls
 * order_msgs__srv__OrderFood_Request__init().
...
/**
 * It calls
 * order_msgs__srv__OrderFood_Request__fini()
 ...
 * order_msgs__srv__OrderFood_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * order_msgs__srv__OrderFood_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * order_msgs__srv__OrderFood_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_order_msgs
...
/**
 * It calls
 * order_msgs__srv__OrderFood_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_order_msgs
...
/**
 * It allocates the memory for the array and calls
 * order_msgs__srv__OrderFood_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_order_msgs
...
/**
 * It calls
 * order_msgs__srv__OrderFood_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ORDER_MSGS__SRV__DETAIL__ORDER_FOOD__FUNCTIONS_H_
